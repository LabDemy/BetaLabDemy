                ...
                <div class="col-xl-5 col-lg-5">
                    <div class="courses_sidebar">
                        <div class="video_thumb">
                            <img src="img/latest_blog/5.jpg" alt="">
                            <a class="popup-video" href="https://www.youtube.com/watch?v=SpvQj-tVZOU">
                        ...
                        <div class="author_info">
                            <div class="auhor_header">
                                <div class="thumb">
                                        <img src="img/latest_blog/mari.png" alt="">
                                </div>
                                <div class="name">
                                    <h3>Mariana Carlo</h3>
                                    <p>CEO "Internacionalización"</p>
                                </div>
                            </div>
                            <p class="text_info">
                               "La tecnología nos permite dar hoy lo que el cliente nos va a pedir mañana"
                            </p>
                            <ul>
